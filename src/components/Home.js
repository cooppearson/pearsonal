				...
				<div className="homeBackground">
					<div className="homeBlurbContainer">
						<div className="homeBlurb">
							...
							<p>
		                        b) a prospective employer who has come to see if my web dev skills are up to snuff and learn a little bit more about me (and who is hopefully not alarmed by my family's humor),
							</p>
							<p>
