					...
					<div className="aboutCanvas">
						...
						<div className="blurbContainer">
							<div className="blurbText">
								...
								<p>
									Software engineer living in the Boston area, skilled in full-stack development. I strive to create
									things as explicitly and elegantly as possible so that others can easily understand my thought process.
						...
						<div className="blurbContainer">
							<div className="blurbText">
								<p className="subject" aria-label="Pearsonal Origin title">
						...
						<div className="blurbContainer">
							...
							<ul className="aboutLinks">
								<li>
									<a
									className="aboutButtons noStyling"
									href='https://github.com/cooppearson/'
									target='_blank'
									aria-label="Link to cooppearson Github"
								...
								<li>
									<a
									className="aboutButtons noStyling"
									href='https://linkedin.com/in/cooperpearson/'
									target='_blank'
									aria-label="Link to cooperpearson Linkedin"
									rel="noopener noreferrer">
									Linkedin
									</a>
								</li>
								<li>
									<a className="aboutButtons noStyling"
									href={Resume}
									target='_blank'
